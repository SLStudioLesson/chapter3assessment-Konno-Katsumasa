    ...
    public static void main(String[] args) {
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(System.in))) {
            ...
            if (choice.equals("1")) {
                ...
                JSONDataHandler jsoDataHandler = new JSONDataHandler();
                RecipeUI recipeUI2 = new RecipeUI(jsoDataHandler);
                recipeUI2.displayMenu();
            }else{
                CSVDataHandler csvDataHandler3 = new CSVDataHandler();
                RecipeUI recipeUI3 = new RecipeUI(csvDataHandler3);
